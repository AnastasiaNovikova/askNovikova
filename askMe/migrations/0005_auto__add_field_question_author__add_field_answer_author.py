...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'askMe_question', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Answer.author'
        db.add_column(u'askMe_answer', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'askMe_question', 'author_id')

        # Deleting field 'Answer.author'
        db.delete_column(u'askMe_answer', 'author_id')
